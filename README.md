...
Эскиз инструкции для разметчиков можно прочесть [здесь](https://github.com/dialogue-evaluation/blob/master/markup_instruction.docx)
...
## Приблизительный таймлайн соревнования:
1. Конец декабря 2019 - выдача примера размеченных данных
2. 1 февраля 2020 - выдача обучающей выборки и всего неразмеченного корпуса
2. 20 февраля 2020 - начало эвалюации на тестовых данных
3. 29 февраля 2020 - публикация финальных моделей
4. 5 марта 2020 - объявление официальных результатов
5. 16 марта 2020 - дедлайн по статьям в сборник конференции Dialogue-2020
